...
const cardTypeColors: Record<CardType, string> = {
  ...
  'question': 'bg-yellow-100 border-yellow-500 text-yellow-700',
  'condition': 'bg-orange-100 border-orange-500 text-orange-700',
  'action': 'bg-emerald-100 border-emerald-500 text-emerald-700',
  'product': 'bg-cyan-100 border-cyan-500 text-cyan-700',
  'service': 'bg-purple-100 border-purple-500 text-purple-700',
  'contact': 'bg-indigo-100 border-indigo-500 text-indigo-700',
  ...
  'confirmacao': 'bg-green-100 border-green-500 text-green-700',
  'documentacao': 'bg-blue-100 border-blue-500 text-blue-700',
  'duvidas': 'bg-yellow-100 border-yellow-500 text-yellow-700',
  'detalhes': 'bg-gray-100 border-gray-500 text-gray-700',
  'orcamento': 'bg-teal-100 border-teal-500 text-teal-700',
  'carrinho': 'bg-cyan-100 border-cyan-500 text-cyan-700',
  'checkout': 'bg-pink-100 border-pink-500 text-pink-700',
  'pedido': 'bg-blue-100 border-blue-500 text-blue-700',
  'problema': 'bg-red-100 border-red-500 text-red-700',
  'solucoes': 'bg-green-100 border-green-500 text-green-700',
  'chamado': 'bg-purple-100 border-purple-500 text-purple-700',
  'faq': 'bg-yellow-100 border-yellow-500 text-yellow-700'
};
