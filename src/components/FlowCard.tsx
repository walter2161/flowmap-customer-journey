...
const cardTypeClasses = {
  ...
  carrinho: 'bg-gradient-to-br from-violet-50 to-violet-100 border-2 border-violet-500',
  checkout: 'bg-gradient-to-br from-emerald-50 to-emerald-100 border-2 border-emerald-500',
  pedido: 'bg-gradient-to-br from-amber-50 to-amber-100 border-2 border-amber-500',
  ...
  chamado: 'bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-500',
...
const cardTypeHeaders = {
  ...
  carrinho: 'bg-violet-500 text-white',
  checkout: 'bg-emerald-500 text-white',
  pedido: 'bg-amber-500 text-white',
  problema: 'bg-red-500 text-white',
  solucoes: 'bg-lime-500 text-white',
  chamado: 'bg-orange-500 text-white',
